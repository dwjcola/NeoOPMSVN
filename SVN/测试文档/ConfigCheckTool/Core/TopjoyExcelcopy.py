...
import json
import re
import Core.LoadWorkbookWithoutStyles as lwws
...
class TopjoyExcel:
    ...
    def _get_valid_column(self, sheet_name):
        ...
        return [cell.col_idx for cell in location_cells if cell.value != None]
    ...
    def _init_schema(self):
        ...
        for sheet_name in self._valid_sheet:
            ...
            for col_idx in valid_cols:
                ...
                link_cell = work_sheet.cell(row=OPTION_ROW, column=col_idx)
    ...
    def format_cell(self, schema, value):
        ...
        if type(type_str_or_list) != list:
            ...
            if schema.get("special_key") == None:
                ...
                if value_new.find(";") >= 0:
                    mark = ";"
                return [self.format_dispatch(type_str_or_list[0], v) for v in value_new.split(mark)]
            else:
        ...
        for sheet_name in self._valid_sheet:
            ...
            for col_idx in valid_cols:
                ...
                if self._need_link(key, value):
                    link = work_sheet.cell(row=OPTION_ROW, column=col_idx).value
